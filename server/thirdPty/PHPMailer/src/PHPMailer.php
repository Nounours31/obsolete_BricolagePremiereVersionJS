...
include_once $_SERVER['DOCUMENT_ROOT'] . 'Bricolage2/server/thirdPty/PHPMailer/src/SMTP.php';
include_once $_SERVER['DOCUMENT_ROOT'] . 'Bricolage2/server/thirdPty/PHPMailer/src/POP3.php';
